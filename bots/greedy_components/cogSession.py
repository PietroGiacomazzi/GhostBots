...
class GreedyGhostCog_Session(gb.GreedyGhostCog): 
    ...
    @commands.before_invoke(gs.command_security(gs.OR(gs.IsAdmin, gs.AND( gs.OR(gs.IsActiveOnGuild, gs.IsPrivateChannelWithRegisteredUser), gs.CanEditRunningSession))))
