...
class GreedyGhostCog_PCMod(gb.GreedyGhostCog):
    ...
    @commands.before_invoke(gs.command_security(gs.genCanCreateCharactertoSomeone(optional_target_user = 3)))
    ...
    @commands.before_invoke(gs.command_security(gs.genIsAdminOrChronicleStoryteller(target_chronicle = 3)))
    ...
    @commands.before_invoke(gs.command_security(gs.genCanEditCharacter(target_character = 2)))
